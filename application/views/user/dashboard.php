...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> <?php echo $this->lang->line('my_profile'); ?>
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#gradingresult" data-toggle="tab"
                                aria-expanded="true"><?php echo $this->lang->line('grading_result'); ?></a></li>
                        <li class=""><a href="#activity" data-toggle="tab"
                                    ...
                                    <div class="col-md-12">
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                ...
                                                <button type="button"
                                                    style="margin-left:10px; font-size:20px; padding:1px 6px;"
                                                    class="btn btn-primary "
                                                    onclick="printview(<?= $student['id'] ?>)"><i
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <select autofocus="" id="period_id" name="period_id"
                                                                            class="form-control">
                                                                            <option value="">
                                            ...
                                            <?php if ($isPrekender) { ?>
                                                <div class="observaciones_container">
                                                    ...
                                                    <textarea id="std_observation" readonly style="width:100%;" rows="3"
                                                        placeholder="Observaciones"><?php echo $observation ?></textarea>
                                                </div>
                                                <div class="table-responsive">
                                                    <form id="update_competence_report">
                                                        <input type="hidden" name="student_session_id"
                                                            value="<?php echo $student_session_id ?>">
                                                        <table class="table table-striped table-bordered table-hover">
                                                            <tbody>
                                                                <?php foreach ($competenceList as $competence) { ?>
                                                                    <tr>
                                                                        <td colspan="<?= count($valuescaleList) + 1 ?>"
                                                                            class="competencerow">
                                                                            <strong><?php echo $competence['name']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $this->lang->line('indicators_achievement'); ?>
                                                                        </th>
                                                                        <?php foreach ($valuescaleList as $valuescale) { ?>
                                                                            <th class="text-center">
                                                                                <?php echo $valuescale['label']; ?></th>
                                                                        <?php } ?>
                                                                    </tr>
                                                                    <?php foreach ($competence['data'] as $indicator) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <?php foreach ($valuescaleList as $key => $valuescale) { ?>
                                                                                <td
                                                                                    class="text-center td_competence_<?= $competence['id'] ?>">
                                                                                    <div style="<?php if ($alledit) { ?>display:none;<?php } ?>"
                                                                                        class="marklabel">
                                                                                        <?php echo $indicator['marks'] == $valuescale['marks'] ? $valuescale['symbol'] : ""; ?>
                                                                                    </div>
                                                                                    <div class="markedit"
                                                                                        data_innerhtml='<input type="radio" name="indicators_<?php echo $indicator['id'] ?>" <?php echo (empty($indicator['marks']) && $key == 0) || $indicator['marks'] == $valuescale['marks'] ? "checked" : ""; ?> value="<?php echo $valuescale['marks'] ?>">'>
                                                                                        <?php if ($alledit) { ?><input type="radio"
                                                                                                name="indicators_<?php echo $indicator['id'] ?>"
                                                                                                <?php echo (empty($indicator['marks']) && $key == 0) || $indicator['marks'] == $valuescale['marks'] ? "checked" : ""; ?>
                                                                                                value="<?php echo $valuescale['marks'] ?>"><?php } ?>
                                                                                    </div>
                                                                                </td>
                                                                            <?php } ?>
                                                                        </tr>
                                            ...
                                            <?php } else { ?>
                                                <div class="box-header with-border">
                                                    <h3 class="box-title">
                                                        CALIFICACIONES DE RENDIMIENTO DE <?php echo $student['class'] ?>
                                                ...
                                                <div class="box-body">
                                                    <div class="table-responsive" id="gradingResultTB">
                                                        <form id="update_subject_report">
                                                            ...
                                                            <?php if ($class_id < 16) { ?>
                                                                <table
                                                                    class="table table-score table-striped table-bordered table-hover competence-<?php echo $competence['id'] ?>"
                                                                    data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="subjectlabelth" colspan="1" rowspan="2">
                                                                                ASIGNATURAS</th>
                                                                            <!-- <th class="pink" colspan="1">COMPETENCIAS FUNDAMENTALES</th> -->
                                                                            <th class="pink" colspan="4" rowspan="1">
                                                                                Comunicativa</th>
                                                                            <th class="pink" colspan="4" rowspan="1">•
                                                                                Pensamiento Lógico, Creativo y <br> Crítico •
                                                                                Resolución de Problemas <br> • Científica y
                                                                                Tecnológica</th>
                                                                            <th class="pink" colspan="4" rowspan="1">• Ética y
                                                                                Ciudadana • Desarrollo <br> Personal y
                                                                                Espiritual <br> • Ambiental y de la Salud</th>
                                                                            <th class="pink" colspan="3" rowspan="1">
                                                                                Calificación final <br> por competencia</th>
                                                                            <th class="lightpink vertical-lr rotated"
                                                                                colspan="1" rowspan="2">CALIFICACIÓN <br> FINAL
                                                                                DEL ÁREA</th>
                                                                            <th class="lightpink vertical-lr rotated"
                                                                                colspan="1" rowspan="2">CALIFICACIÓN <br>
                                                                                RECUPERACIÓN <br> FINAL</th>
                                                                        </tr>
                                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        <?php foreach ($grading_subject_results as $result) { ?>
                                                                            <tr>
                                                                                ...
                                                                                for ($iii = 0; $iii < 3; $iii++) { ?>
                                                                                    <td
                                                                                        class="td_subject <?php if ($i % 4 == 2)
                                                                                            echo 'right-red' ?> ">
                                                                                            <div class="marklabel"
                                                                                                canedit="<?php echo $period['canedit']; ?>">
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="pink" colspan="8" rowspan="1">• Pensamiento
                                                                        Lógico, Creativo y <br> Crítico • Resolución de
                                                                        Problemas <br> • Científica y Tecnológica</th>
                                                                    <th class="pink" colspan="8" rowspan="1">• Ética y Ciudadana
                                                                        • Desarrollo <br> Personal y Espiritual <br> • Ambiental
                                                                        y de la Salud</th>
                                                                    <th class="pink" colspan="3" rowspan="1"> Calificación final
                                                                        <br> por competencia</th>
                                                                    <th class="lightpink vertical-lr rotated" colspan="1"
                                                                        rowspan="2">CALIFICACIÓN <br> FINAL DEL ÁREA</th>
                                                                    <th class="lightpink vertical-lr rotated" colspan="1"
                                                                        rowspan="2">CALIFICACIÓN <br> RECUPERACIÓN <br> FINAL
                                                                    </th>
                                                                    <th class="lightpink vertical-lr rotated" colspan="1"
                                                                        rowspan="2">CALIFICACIÓN <br> RECUPERACIÓN <br> ESPECIA
                                                                    </th>
                                                                </tr>
                                                                <tr>
                                                                    <th class="lightpink">P1</th>
                                            ...
                                            <div style="padding-bottom:10px">
                                                <table class="explain_field">
                                                    <tr>
                                                        <td class="border-right-2"><strong>C.F.</strong> = Calificación Fina
                                                        </td>
                                                        <td><strong>%A.A.</strong> = Porciento Asistencia Anual</td>
                                                        <td class="border-left-2"><strong>P.C.P.</strong>= Promedio de
                                                            Calificaciones Parciales</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border-right-2"><strong>C.P.C.</strong>= Calificación
                                                            Prueba Completiva</td>
                                                        <td colspan="2"><strong>C.C.</strong>= Calificación Completiva igual
                                                            al 50% Promedio Calificación Parcial + 50% Prueba Completiva
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border-right-2"><strong>C.P.EX.</strong>= Calificación
                                                            Prueba Extraordinaria</td>
                                                        <td colspan="2"><strong>C.EX.</strong>= Calificación Extraordinaria
                                                            igual al 30% Promedio Calificación Parcial + 70% Prueba
                                                            Extraordinaria</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border-right-2 pb-2"><strong>A</strong>= Aprobado con 70
                                                            o más</td>
                                                        <td class="pb-2"><strong>R</strong>= Reprobado con menos de 70
                                                            puntos</td>
                                                        <td class="border-left-2 pb-2"><strong>C.A.P.</strong>= Calificación
                                                            Asignaturas Pendientes</td>
                                                    </tr>
                                                </table>
                                                <div style="margin-top 20px;font-weight: bolder; color:black;">
                                                    <span
                                                        style="padding:1px 20px 1px 10px; background:#CCC; border:solid 1px black">CONDICIÓN
                                                        FINAL:</span> &nbsp;&nbsp; Promovido <span
                                                        style="padding:1px 20px; border:solid 1px black">X</span>
                                                    &nbsp;&nbsp; Reprobado <span
                                                        style="padding:1px 20px; border:solid 1px black">X</span>
                                                    &nbsp;&nbsp; Promovido con asignaturas pendientes <span
                                                        style="padding:1px 20px; border:solid 1px black">X</span>
                                                </div>
...
<div class="tab-pane" id="activity">
    ...
    <div class="tshadow mb25 bozero">
        <h3 class="pagetitleh2"><?php echo $this->lang->line('address'); ?> <?php echo $this->lang->line('detail'); ?>
        </h3>
        <div class="table-responsive around10 pt0">
            <table class="table table-hover table-striped">
                <tbody>
                                    ...
                                    if (!empty($fee_value->amount_detail)) {
                                        ...
                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                            ...
                                            <tr class="white-td">
                                                ...
                                                <td class="text text-right">
                                                    <?php echo (number_format($fee_deposits_value->amount_discount, 2, '.', '')); ?></td>
                                                <td class="text text-right">
                                                    <?php echo (number_format($fee_deposits_value->amount_fine, 2, '.', '')); ?></td>
                                                ...
                                                <div class="fee_detail_popover" style="display: none">
                                                    ...
                                                    if ($fee_deposits_value->description == "") {
                                                        ...
                                                        <p class="text text-danger">
                                                            <?php echo $discount_value['student_fees_discount_description'] ?></p>
                                                        <?php
                                                    }
                                                    ?>
                                                </div>
                        ...
                        <li>
                            ...
                            <div class="timeline-item">
                                <?php if (!empty($value["document"])) { ?>
                                    <span class="time"><a data-placement="left" class="defaults-c text-right" data-toggle="tooltip"
                                            title=""
                                            href="<?php echo base_url() . "user/user/timeline_download/" . $value["id"] . "/" . $value["document"] ?>"
...
<div class="tab-pane" id="documents">
    ...
    <div class="timeline-header no-border">
        <button type="button" data-student-session-id="<?php echo $student['student_session_id'] ?>"
            class="btn btn-xs btn-primary pull-right myTransportFeeBtn mb10"> <i class="fa fa-upload"></i>
                            ...
                            <tr>
                                ...
                                <td class="mailbox-date text-right">
                                    <a data-placement="left"
                                        href="<?php echo base_url(); ?>user/user/download/<?php echo $value['student_id'] . "/" . $value['doc']; ?>"
                                        ...
                                        if ($exam_value->exam_type != "gpa") {
                                            ...
                                            <div class="col-sm-3 col-lg-3 col-md-3">
                                                <div class="description-block">
                                                    <h5 class="description-header"><?php echo $this->lang->line('percentage') ?> : <span
                                            ...
                                            <div class="col-sm-4 col-lg-4 col-md-4 border-right">
                                                <div class="description-block">
                                                    <h5 class="description-header"><?php echo $this->lang->line('result') ?> :<span
                                            ...
                                            <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                                <div class="description-block">
                                                    <h5 class="description-header">
                                                        <?php echo $this->lang->line('grand') . " " . $this->lang->line('total') ?> : <span
                                                            class="description-text"><?php echo $exam_grand_total; ?></span></h5>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="description-block">
                                                    <h5 class="description-header">
                                                        <?php echo $this->lang->line('credit') . " " . $this->lang->line('hours'); ?> : <span
                                                            class="description-text"><?php echo $exam_credit_hour; ?></span></h5>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="description-block">
                                                    <h5 class="description-header">
                                                        <?php echo $this->lang->line('quality') . " " . $this->lang->line('points') ?> : <span
                                                            class="description-text">
                                                            <?php
                            ...
                            <div class="col-md-12">
                                <div class="bgtgray">
                                    ...
                                    if ($consolidate_exam_result_percentage) {
                                        ...
                                        <div class="col-sm-3 border-right no-print">
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('division'); ?> :<span
                                                        class="description-text">
                                                        <?php
        ...
        <div class="modal-dialog modal-sm400">
            <div class="modal-content">
                ...
                <div class="modal-body pb0">
                    <form id="form11" name="employeeform" method="post" accept-charset="utf-8"
                        ...
                        <div id='upload_documents_hide_show'>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('documents'); ?> <small
                                        class="req">*</small></label>
                                <div class="">
...
<script type="text/javascript">
    ...
    function printview(id) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "user/user/printCard",
            data: {
                id: id,
                period_id: period_id,
