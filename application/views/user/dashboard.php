                                   ...
                                   <div class="box box-primary">
                                       ...
                                       <?php if ($isPrekender) { ?>
                                           <div class="observaciones_container">
                                               ...
                                               <textarea id="std_observation" readonly style="width:100%;" rows="3" placeholder="Observaciones"><?php echo $observation ?></textarea>
                                           </div>
                                               ...
                                               <div class="table-responsive" id="gradingResultTB">
                                                   <form id="update_subject_report">
                                                       ...
                                                       <table class="table table-striped table-bordered table-hover competence-<?php echo $competence['id'] ?>" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
                                                           ...
                                                           <tr>
                                                               ...
                                                               <th colspan="<?php echo count($periodList) + 1 ?>">CALIFICACIONES DEL AÑO ESCOLAR</th>
                                                               <th rowspan="3">% A.A</th>
                                                               <?php if ($addstep > 0) { ?>
                                                           ...
                                                           <?php foreach ($grading_subject_results as $result) { ?>
                                                               <tr>
                                                                   ...
                                                                   <?php for ($i = 0; $i < count($periodList); $i++) { ?>
                                                                       <td class="td_subject">
                                                                           <div class="marklabel">
                                                                               <?php echo $result['period_results'][$i] ?>
                                                                           </div>
                                                                           <?php if($result['edit_flag'][$i] == 1) {?>
                                                                           <div class="markedit" data_innerhtml='<input type="number" min="0" max="100" style="width:60px;" name="secondaryreport_<?= $result['subjectId'] ?>_p<?= $i + 1 ?>" value="<?= $result['period_results'][$i] ?>">'>
                                                                               <?php } ?>
                                                                           </div>
                                                                       </td>
                                                                   <?php } ?>
                                                    ...
                                                    <td <?php if ($result['add'] != '') { ?>class="td_subject" <?php } ?>>
                                                        <div class="marklabel">
                                                            <?php echo $result['CPC'] ?>
                                                        </div>
                                                        <div class="markedit" data_innerhtml='<input type="number" min="0" max="100" style="width:60px;" name="secondaryreport_<?= $result['subjectId'] ?>_CPC" value="<?= $result['CPC'] ?>">'>
                                                        </div>
                                                    </td>
                                                    </td>
                                                ...
                                                <?php } ?>
                                                                   <?php if ($addstep > 1) { ?>
                                                                       ...
                                                                       <td <?php if ($result['add'] == 'cpex') { ?>class="td_subject" <?php } ?>>
                                                                           <div class="marklabel">
                                                                               <?php echo $result['CPEX'] ?>
                                                                           </div>
                                                                           <div class="markedit" data_innerhtml='<input type="number" min="0" max="100" style="width:60px;" name="secondaryreport_<?= $result['subjectId'] ?>_CPEX" value="<?= $result['CPEX'] ?>">'>
                                                                           </div>
                                                                       </td>
                                                                       <td><?php echo $result['70CPEX'] ?></td>
                                                                       <td><?php echo $result['CEX'] ?></td>
                                                                   <?php } ?>
