<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('grading_report_periods', 'can_add')) {
            ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add') . " " . $this->lang->line('period'); ?></h3>
                        </div>
                        <form id="period_form" name="period_form" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="label" name="label" class="form-control" value="<?php echo set_value('label') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="start_month" name="start_month" class="form-control">
                                        ...
                                        <?php foreach ($monthlist as $m_key => $month) { ?>
                                                ...
                                                if (set_value('start_month') == $m_key) {
...
<script>
    ...
    $("#period_form").on('submit', (function(e) {
        ...
        $.ajax({
            url: base_url + "admin/grading_period/create",
            type: "POST",
