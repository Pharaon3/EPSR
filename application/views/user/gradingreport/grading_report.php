                                ...
                                <table class="table table-striped table-bordered table-hover competence-<?php echo $competence['id'] ?>" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="<?php echo (count($periodList)<=4 ? 4 : count($periodList)) + 1 ?>">CALIFICACIONES DEL AÑO ESCOLAR</th>
                                            <th rowspan="3">% A.A</th>
                                            <?php if ($addstep > 0) { ?>
                                        ...
                                        <tr>
                                            <th colspan="<?php echo count($periodList)<=4 ? 4 : count($periodList) ?>">Calificaciones Parciales</th>
                                            <th rowspan="2">C.F.</th>
                                            <?php if ($addstep > 0) { ?>
                                        ...
                                        <tr>
                                            <?php $i = 0;foreach( $periodList as $per) { ?>
                                                <th><?php echo $per['label'];$i++; ?></th>
                                            <?php } ?>
                                            <?php for ($ii = $i; $ii < 4; $ii++) { ?>
                                                <th>&nbsp;</th>
                                            <?php } ?>
                                            <th>1</th>
                                            <th>2</th>
