<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('level', 'can_add')) {
            ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add') . " " . $this->lang->line('level'); ?></h3>
                        </div>
                        <form action="<?php echo site_url('levels/index') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="level"><?php echo $this->lang->line('level') . " " . $this->lang->line('name'); ?> </label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="coordinator_id" name="coordinator_id" class="form-control">
                                        ...
                                        ?>
                                            <option <?php
                                                    if (set_value('coordinator_id') == $coordinator["id"]) {
                                                        echo "selected";
                                                    }
                                                    ?> value="<?php echo $coordinator['id'] ?>"><?php echo $coordinator["name"] . " " . $coordinator["surname"]; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
