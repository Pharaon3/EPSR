                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-collapse navborder" id="navbar-collapse-3">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            ?>
                            <li><a class="login-btn" href="<?php echo site_url('site/userlogin') ?>"><i class="fa fa-user"></i><?php echo $this->lang->line('student') ?>/<?php echo $this->lang->line('parent') ?></a></li>
                            <li><a class="login-btn" href="<?php echo site_url('site/login') ?>"><i class="fa fa-user"></i><?php echo $this->lang->line('admin') ?>/<?php echo $this->lang->line('staff') ?></a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </nav><!-- /.navbar -->
            </div>
