            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-7">
                    <ul class="header-extras">
                        ...
                        <li><a class="complainbtn" href="<?php echo site_url('site/userlogin') ?>"><?php echo $this->lang->line('student') ?>/<?php echo $this->lang->line('parent') ?></a></li>
                        <li><a class="complainbtn" href="<?php echo site_url('site/login') ?>"><?php echo $this->lang->line('admin') ?>/<?php echo $this->lang->line('staff') ?></a></li>
