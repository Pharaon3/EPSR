                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <ul class="topicon">
                                    ...
                                    <li><a class="login" href="<?php echo site_url('site/userlogin') ?>"><i class="fa fa-user"></i><?php echo $this->lang->line('student') ?>/<?php echo $this->lang->line('parent') ?></a></li>
                                    <li><a class="login" href="<?php echo site_url('site/login') ?>"><i class="fa fa-user"></i><?php echo $this->lang->line('admin') ?>/<?php echo $this->lang->line('staff') ?></a></li>
                                </ul>
                            </div><!--./col-md-3-->
                        </div>
                    </div>
