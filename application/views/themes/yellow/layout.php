            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <ul class="top-right">
                            <li><a href="<?php echo site_url('site/userlogin') ?>"><i class="fa fa-user"></i><?php echo $this->lang->line('student') ?>/<?php echo $this->lang->line('parent') ?></a></li>
                            <li><a href="<?php echo site_url('site/login') ?>"><i class="fa fa-user"></i><?php echo $this->lang->line('admin') ?>/<?php echo $this->lang->line('staff') ?></a></li>
                        </ul>
                    </div><!--./col-md-5-->
                </div>
            </div>
