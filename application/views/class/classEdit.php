                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('classes/edit/' . $id) ?>" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <input type="hidden" name="pre_level_id" value="<?php echo $vehroute[0]->level_id; ?>">
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="level_id" name="level_id" class="form-control">
                                        ...
                                        <?php foreach ($levelList as $level) { ?>
                                            <option value="<?php echo $level['id']; ?>" <?php if (set_value('level_id',  $vehroute[0]->level_id) == $level['id']) echo "selected=selected" ?>>
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('level'); ?>
                                        </th>
