                            ...
                            <div class="bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('current')." ".$this->lang->line('session'); ?></label>
                                                <input id="" name="roll_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('roll_no'); ?>" />
                                                <span class="text-danger"><?php echo form_error('roll_no'); ?></span>
                                            </div>
                                        </div> -->
                                        <?php if (0)//$sch_setting->roll_no) 
                                        { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
