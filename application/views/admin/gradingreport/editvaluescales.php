    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('edit') . " " . $this->lang->line('value_scale'); ?></h3>
                    </div>
                    <form id="valuescale_form" name="valuescale_form" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="marks" name="marks" class="form-control" value="<?php echo $marks ?>">
                            </div>

                            <div class="form-group">
                                <label><?php echo $this->lang->line('symbol'); ?></label>
                                <input type="text" id="symbol" name="symbol" class="form-control" value="<?php echo $symbol ?>">
                            </div>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line("value_scale") . " " . $this->lang->line('list') ?></h3>
...
<script>
    $(document).ready(function(e) {
        ...
        $("#valuescale_form").on('submit', (function(e) {
            ...
            $.ajax({
                url: base_url + "admin/grading_result/updatevaluescales",
                type: "POST",
