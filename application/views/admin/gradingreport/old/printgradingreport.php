<style type="text/css" media="print">
    @page
    {
        size: 11.0in 8.5in;   /* auto is the initial value */
        margin: 0.01in;  /* this affects the margin in the printer settings */
    }
        ...
        <tbody>
            ...
            if (!empty($studentlist)) {
                ...
                while($i > 0) 
                {
                    ...
                    <?php
                    if( $i < count($studentlist) && $number % 14 == 0)
                    {
                        echo "</tbody>";
                        echo "</table>";
                        echo '<div class="pagebreak"></div>';
                        echo '<div class="break"></div>';
                        echo '<table cellpadding="1" cellspacing="0" width="100%" class="tablemain" style="margin-top:30px;" border="1">
                        <thead>
                            <tr>
