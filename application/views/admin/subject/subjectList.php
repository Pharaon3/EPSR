                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/subject') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('sub_on_weekly'); ?></label><small class="req"> *</small>
                                    <input id="category" name="sub_on_weekly" placeholder="" type="number" class="form-control"  value="<?php echo set_value('sub_on_weekly'); ?>" />
                                    <span class="text-danger"><?php echo form_error('sub_on_weekly'); ?></span>
                                </div>
                            </div>
            ...
            ?>">            
                <div class="box box-primary" id="sublist">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-header ptbnull">
                            <form id="form1" action="<?php echo site_url('admin/subject/update_sub_onWeekly') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                                <button type="submit" class="btn-info pull-right"><?php echo $this->lang->line('update'); ?></button>
                                <input id="sub_on_weekly" name="sub_on_weekly" type="number" class="pull-right"></input>
                                <label for="exampleInputEmail1" class ="pull-right" style="padding-right:10px;"><?php echo $this->lang->line('sub_on_weekly'); ?>
                            </form>
                        </div>
                    </div>
                    <div class="box-body">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center;"><?php echo $this->lang->line('sub_on_weekly'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($subjectlist as $subject) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name" style="text-align:center;"> <?php echo $subject['sub_on_weekly'] ?></td>
