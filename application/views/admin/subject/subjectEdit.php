                        ...
                        <form action="<?php echo site_url("admin/subject/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="category" name="name" placeholder="" type="text" class="form-control"  
                                    value="<?php echo set_value('name', $subject['name']); ?>" />
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <input id="subject_order" name="order" placeholder="" type="number" class="form-control"  
                                    value="<?php echo set_value('order', $subject['order']); ?>" />
                                </div>
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('sub_on_weekly'); ?></label><small class="req"> *</small>
                                    <input id="sub_on_weekly" name="sub_on_weekly" placeholder="" type="number" class="form-control" 
                                     value="<?php echo set_value('sub_on_weekly', $subject['sub_on_weekly']); ?>" />
                                </div>
                            </div>
