                ...
                <table class="table table-bordered table-hover order-list tablewidthRS" id="tab_logic">
                    <thead>
                        <tr>
                            ...
                            <th>
                                 <?php echo $this->lang->line('time');?><small class="astrike"> *</small>
                            </th>
                            <!-- <th>
                            </th> -->
                            <th>
                    ...
                    <tbody>
                        ...
                        if (!empty($prev_record)) {
                            ...
                            <tr id='addr0'>
                                ...
                                <td class="col-md-3 relative">
                                    <select class="form-control staff" id="lesson_id_<?php echo $counter; ?>" name="lesson_<?php echo $counter; ?>">
                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                        <?php
                                        $idx = 1;
                                        foreach ($lesson_timetables as $lesson_key => $lesson_value) {
                                            ?>
                                                <option value="<?php echo $lesson_value['id']; ?>" <?php echo set_select('lesson_' . $counter, $lesson_value['id'], ($prev_rec_value->lesson_id == $lesson_value['id'] ) ? TRUE : FALSE ); ?> ><?php echo $lesson_value['time_from'] . " - " . $lesson_value['time_to']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <!-- <td>
                                    <div class="input-group">
                                        <input type="text" name="time_from_<?php echo $counter; ?>" class="form-control time_from time" id="time_from_<?php echo $counter; ?>" 
                                        value="<?php echo ($prev_rec_value->start_time != "") ? $prev_rec_value->time_from :  $this->customlib->timeFormat($prev_rec_value->start_time);?>">
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="time_to_<?php echo $counter; ?>" class="form-control time_to time" id="time_to_<?php echo $counter; ?>" 
                                        value="<?php echo ($prev_rec_value->end_time != "") ? $prev_rec_value->time_to :  $this->customlib->timeFormat($prev_rec_value->end_time);?>">
                                        <div class="input-group-addon">
                                            <span class="fa fa-clock-o"></span>
                                        </div>
                                    </div>
                        ...
                        <tr id='addr0'>
                            ...
                            <td class="col-md-3 relative">
                                <select class="form-control staff" id="lesson_id_<?php echo $total_count; ?>" name="lesson_<?php echo $total_count; ?>">
                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                    <?php
                                    foreach ($lesson_timetables as $lesson_key => $lesson_value) {
                                        ?>

                                        <option value="<?php echo $lesson_value['id']; ?>"><?php echo $lesson_value['time_from'] . " - " . $lesson_value['time_to']; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('form#form_' + form_id).on('submit', function (event) {
            ...
            $('input[id^="lesssion_id_"]').each(function () {
                $(this).rules('add', {
                    required: true,
                    messages: {
                        required: "Required"
...
?>
            ...
            <script type="text/template" id="lesson_dropdown">
                <option value=""><?php echo $this->lang->line('select') ?></option>
                <?php
foreach ($lesson_timetables as $lesson_key => $lesson_value) {
    ?>
