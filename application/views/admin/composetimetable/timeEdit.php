<div class="content-wrapper">   
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('compose_timetable', 'can_add') || $this->rbac->hasPrivilege('compose_timetable', 'can_edit')) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('update') . " " . $this->lang->line('time'); ?></h3>
                        </div>
                        <form action="<?php echo site_url('admin/composetimetable/edit/'. $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="width:100%;display: flex;">
                                        <div style="width:50%">
                                            <div class="input-group"><input type="text" name="time_from" class="form-control time_from time" id="time_from"  
                                            aria-invalid="false"placeholder="From" value="<?php echo set_value('time_from', $lesson_time['time_from']); ?>"/>
                                        ...
                                        <div style="width:50%;float:right;">
                                            <div class="input-group"><input type="text" name="time_to" class="form-control time_to time" id="time_to"  
                                            aria-invalid="false" placeholder="To" value="<?php echo set_value('time_to', $lesson_time['time_to']); ?>"/>
                                            <div class="input-group-addon"><i class="fa fa-clock-o"></i></div></div>
                                    ...
                                    <div style="width:100%;display: flex;">
                                        <div class="input-group" style="width:100%; float:left;">
                                            <select autofocus="" id="time_type" name="time_type" class="form-control" >
                                                <option <?php echo $lesson_time['time_type']==0 ? "selected" : ""; ?> value='0'>Lesson Time</option>
                                                <option <?php echo $lesson_time['time_type']==1 ? "selected" : ""; ?> value='1'>Rest Time</option>
                                                <option <?php echo $lesson_time['time_type']==2 ? "selected" : ""; ?> value='2'>Other Time</option>
                                                </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div style="width:100%;display: flex;">
                                        <div class="input-group" style="width:100%; float:left;">
                                            <input autofocus="" id="description" name="description"
                                                        value="<?php echo $lesson_time['description'] ?>"
            ...
            if ($this->rbac->hasPrivilege('compose_timetable', 'can_add') || $this->rbac->hasPrivilege('level', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
