...
<div id="grading_table">
    <table cellpadding="0" cellspacing="0" width="100%" class="tablemain" border="1">
        <thead>
            <tr>
            ...
            if (!empty($studentlist)) {
                ...
                while($i > 0) 
                {
                    ...
                    <tr>
                        ...
                        ?>
                        <td><?php echo $studentlist[$i]['totalCF']/ count($subject_list); ?></td>
                    </tr>
                    <?php
                    if( $i < count($studentlist) && $number % 17 == 0)
                    {
                        echo "</tbody>";
                        echo "</table>";
                        ...
                        <thead>
                            <tr>
                                ...
                                <th id="section">'. $this->lang->line('section').'</th>
