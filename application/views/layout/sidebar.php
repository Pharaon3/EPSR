<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            if ($this->module_lib->hasActive('nurse_dept')) {
                if (($this->rbac->hasPrivilege('nurse_dept_search', 'can_view'))) {
                ?>
                    <li class="treeview <?php echo set_Topmenu('Nurse_Dept'); ?>">
                        <a href="#">
                            <i class="fa fa-calendar-check-o ftlayer"></i> <span><?php echo $this->lang->line('Nurse Dept'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php {
                                //if ($this->rbac->hasPrivilege('student_attendance', 'can_view'))
                                {
                            ?>
                                    <li class="<?php echo set_Submenu('Nurse_Dept/index'); ?>"><a href="<?php echo base_url(); ?>admin/nurse"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('Nurse Dept Search'); ?></a></li>
                            <?php
                                }
                            }
                            ?>
            ...
            if ($this->module_lib->hasActive('psychology')) {
                if (($this->rbac->hasPrivilege('psychology_search', 'can_view'))) {
                ?>
                    <li class="treeview <?php echo set_Topmenu('Psychology'); ?>">
                        <a href="#">
                            <i class="fa fa-calendar-check-o ftlayer"></i> <span><?php echo $this->lang->line('Psychology'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php {
                                {
                            ?>
                                    <li class="<?php echo set_Submenu('Psychology/index'); ?>"><a href="<?php echo base_url(); ?>admin/psychology"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('Psychology Search'); ?></a></li>
                            <?php
                                }
                            }
                            ?>
            ...
            if ($this->module_lib->hasActive('grading_report')) {
                if ($this->rbac->hasPrivilege('grading_report_competences:', 'can_view') ||
                    $this->rbac->hasPrivilege('grading_report_indicators:', 'can_view') ||
                    $this->rbac->hasPrivilege('grading_report_results', 'can_view')) {
                ?>
                    <li class="treeview <?php echo set_Topmenu('GradingReport'); ?>">
                        <a href="#">
                            <i class="fa fa-map-o ftlayer"></i> <span><?php echo $this->lang->line('grading_report'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">

                            <?php if ($this->rbac->hasPrivilege('grading_report_competences', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('GradingReport/Competences'); ?>"><a href="<?php echo site_url('admin/grading_competence/competences'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('grading_competences') ?></a></li>
                            <?php }
                            ?>
                            <?php if ($this->rbac->hasPrivilege('grading_report_indicators', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('GradingReport/Indicators'); ?>"><a href="<?php echo site_url('admin/grading_indicators'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('grading_indicators') ?></a></li>
                            <?php }
                            ?>
                            ...
                            <?php }
                            ?>
                            <?php if ($this->rbac->hasPrivilege('grading_report_valuescale', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('GradingReport/Valuescale'); ?>"><a href="<?php echo site_url('admin/grading_result/valuescales'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('value_scale') ?></a></li>
                            <?php }
                            ?>
                            <?php if ($this->rbac->hasPrivilege('grading_report_period', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('GradingReport/Period'); ?>"><a href="<?php echo site_url('admin/grading_period'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('period') ?></a></li>
                            <?php }
                            ?>
                            <?php if ($this->rbac->hasPrivilege('grading_report_permissionteacher', 'can_edit')) { ?>
                                <li class="<?php echo set_Submenu('GradingReport/permissionteacher'); ?>"><a href="<?php echo site_url('admin/grading_result/permissionteacher'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('permission_teacher') ?></a></li>
                            <?php }
                            ?>
                        </ul>
                    </li>
    ...
    ?>
            ...
            if ($this->module_lib->hasActive('academics')) {
                if (($this->rbac->hasPrivilege('class_timetable', 'can_view') ||
                    ...
                    $this->rbac->hasPrivilege('compose_timetable', 'can_view') ||
                    $this->rbac->hasPrivilege('level', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('level', 'can_view')) {
                                ?>
                                    <li class="<?php echo set_Submenu('level/index'); ?>"><a href="<?php echo base_url(); ?>levels"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('level'); ?></a></li>
                                <?php
                                }
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('classes/timezone'); ?>"><a href="<?php echo base_url(); ?>classes/timezone"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('class_timezone'); ?></a></li>
                            <?php
                            }
                            ...
                            ?>
                             <li class="<?php echo set_Submenu('composetimetable/index'); ?>"><a href="<?php echo base_url(); ?>admin/composetimetable"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('compose_timetable'); ?></a></li>
                            <?php
                            /* 
                            <li class="<?php echo set_Submenu('composetimezone/index'); ?>"><a href="<?php echo base_url(); ?>admin/composetimezone"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('compose_timezone'); ?></a></li> 
                            // */
                            }
                            ?>
                        </ul>
