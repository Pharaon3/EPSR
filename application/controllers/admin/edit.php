                                    ...
                                    <table class="table table-striped table-bordered table-hover student-list" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="darksalmon" colspan="<?php echo (count($periodList)<=4 ? 4 : count($periodList)) + 1 ?>">CALIFICACIONES DEL AÑO ESCOLAR</th>
                                                <?php //if ($addstep > 0) { 
                                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <th class="lightblueCF" rowspan="2">C.F.</th>
                                                <?php //if ($addstep > 0) { 
                                                ?>
        ...
        <div class="forprintlayout" style="display: none;">
            ...
            <table class="print-table" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('list'); ?>">
                <thead>
                    ...
                    <tr>
                        <th colspan="<?php echo count($periodList) ?>" id="califi">Calificaciones Parciales</th>
                        <th class="lightblueCF" rowspan="2">C.F.</th>
                        <?php //if ($addstep > 0) { 
                        ?>
                        <th rowspan="2">50% P.C.P.</th>
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('student_name'); ?></th>
                        <?php $i = 0;foreach( $periodList as $per) { ?>
                            <th colspan="1" id="period<?php echo $i;?>"><?php echo $per['label'];$i++; ?></th>
                        <?php } ?>
                        <th colspan='1' id="extra">1</th>
                        <th>2</th>
                    </tr>
                </thead>
                <tbody>
...
<script type="text/javascript">
    function printsubjectreport() {
        var $table = $('.forprintlayout');
        // var role = '<?php echo $role_id;?>';
        // console.log(role);
        // if(role == 2)       //if he/she is Teacher
        // {
        //     $table.find("tbody tr, thead tr")
        //     .find(".lightblueCF")
        //     .hide()
        //     $table.find("td:nth-child(8)").hide();
        //     $table.find("td:nth-child(7)").attr("colspan",2);
        //     $table.find("#califi").attr("colspan",5);
        //     $table.find("#period3").attr("colspan",2);
        // }
        //console.log($table.html());
        //print.$('td:nth-child('+index+')').hide();
        Popup($table.html());
    }
                    ...
                    if (!response.status) {
                        ...
                        table = $('.student-list').DataTable({
                            ...
                            "rowCallback": function(nRow, aData, iDisplayIndex) {
                                ...
                                var period_count = <?= count($periodList)<=4 ? 4 : count($periodList) ?> * 1;
                                $('td:eq(' + (3 + period_count) + ')', nRow).addClass('lightblueCF');
                        ...
                        ptable = $('.print-table').DataTable({
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url": baseurl + "admin/grading_result/dteditstudentlistforprint",  //d
                                "dataSrc": 'data',
                                "type": "POST",
                                'data': response.params,
                            }
