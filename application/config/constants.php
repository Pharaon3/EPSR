...
defined('MAXLIMIT_LESSONCOUNT_PERWEEK') OR define('MAXLIMIT_LESSONCOUNT_PERWEEK', 30);

defined('TIME_AMPM') OR define('TIME_AMPM', 
                                            [
                                              ['id'=>1, 'name'=>'MATUTINO'], 
                                              ['id'=>2, 'name'=>'VESPERTINO']
                                            ]);
defined('TIME_TYPE') OR define('TIME_TYPE', 
                                            [
                                              ['id'=>0, 'namekey'=>'time_type_lesson'], 
                                              ['id'=>1, 'namekey'=>'time_type_rest'], 
                                              ['id'=>2, 'namekey'=>'time_type_other']
                                            ]);                                            